...
\quad$\cdot$\quad Tensor networks for strongly correlated systems \quad$\cdot$\quad Topological and
...
\cvitem{Numerical methods}{Tensor networks (DMRG), exact diagonalization, finite-difference PDE solvers}
