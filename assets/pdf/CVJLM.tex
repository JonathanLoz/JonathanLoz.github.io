...
\cvitem{2024}{\textbf{J. Lozano-Mayo} and M. Torres. Multi-kinks in scalar field
theories with non-degenerate vacua: the modulated double sine-Gordon model.
\textit{(Accepted).}}
...
\cvitem{2024-2025}{
\textit{ALICE Collaboration}: Contributed to ITS performance analysis, and hadron-$D^0$ azimuthal-correlation studies as service work during December 2025-October 2026. Publications bearing my name under ALICE's collective authorship policy are not listed here.}
